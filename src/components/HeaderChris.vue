    ...
    <div class="head-wrap">
      <div class="head-content">
        <!-- <div class="icon" @click="goPath('/', 1)">
          <img src="../assets/imgs/dragon-icon4.png" alt="" />
        </div> -->
        <div class="menu-wrap">
          <div
            :class="
  ...
  setup(props, context) {
    ...
    const state = reactive({
      ...
      earnList: [
        ...
        {
          itemIcon: require("@/assets/imgs/head/community/more-icon7.png"),
          itemText: "Skull",
          type: 4,
        },
      ],
    ...
    const goMore = (item) => {
      if (item.type == 1) {
        ...
        window.open(
          "https://static.dragonmainland.io/paper/DMS+Whitepaper.pdf",
          "_blank"
        );
      } else if (item.type == 3) {
        window.open(
          "https://static.dragonmainland.io/paper/REP-Dragon-Mainland.pdf",
          "_blank"
        );
      } else if (item.type == 6) {
        window.open(
          "https://static.dragonmainland.io/paper/White Paper on Economic Model.pdf",
          "_blank"
        );
      } else if (item.type == 4) {
        // context.emit("createEgg");
        context.emit("downLoadGame");
      } else if (item.type == 5) {
        state.selectItem = 7;
...
//   align-items: center;
  .head-wrap {
    ...
    background-image: url("../assets/imgs/head/chris/head-bc.png");
    .head-content {
      display: flex;
      ...
      .menu-wrap {
        ...
        .selectItem-list5 {
          ...
          .selectItem-list-wrap {
            ...
            background-repeat: no-repeat;
            background-size: cover;
            background-image: url("../assets/imgs/head/chris/sub-menu-bc.png");
