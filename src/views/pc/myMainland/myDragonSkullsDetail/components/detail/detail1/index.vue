    ...
    <div class="left">
      ...
      <div class="tetail-num">
        ...
        <div class="dragon-my-btn">
          <div class="btn-wrap" v-if="true">
            <div
              v-if="true"
              class="item-btn select-no-hover"
              @click="sendDragon"
            ...
            <div
              v-if="dragonDetail.usable >= 5 && dragonDetail.level != 3"
              class="item-btn select-no-hover"
              @click="goCreateSkull"
            ...
            <div v-else class="item-btn no-data select-hover">
              <img
                src="@/assets/imgs/myMainland/dragonDetail/dragon-my-btn/synthesis.png"
                alt=""
              />
