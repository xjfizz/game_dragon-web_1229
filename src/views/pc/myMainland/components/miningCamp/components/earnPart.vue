    ...
    >
      <div class="modal-contain">
        <div class="modal-content">
          <div class="title">Collect Reward</div>
          <div class="content">
            <div class="detail-top">
              {{ localEarnDetail.hours }} hours of earnings can be collected
            </div>
            <div class="detail-mid">
              <div class="detail-left">Earned Reward(DMP):</div>
              <div class="detail-right">
                {{ localEarnDetail.earnedReward || 0 }} DMP
              </div>
            </div>
          ...
          <div class="content-btns">
            <div class="cancel select-hover" @click="cancelPartEarn">
              Cancel
            </div>
            <div
              v-if="localEarnDetail.status == 1"
              class="confirm select-hover"
              @click="rewardPartEarn"
            >
              Sure
            </div>
...
export default {
  ...
  setup(props, context) {
    ...
    const { miningCampRightState, rewardPartEarn, cancelPartEarn } =
