      ...
      <div class="modal-contain">
        <div class="modal-content">
          ...
          <div class="content">
            <div class="detail-top">
              ...
              <div class="detail-right">
                <div class="total">{{ miningWaitCampListSelected.length }}</div>
                <div class="power">
                  Hash power: {{ confirmDetailsForm.totalPower || 0 }}
                </div>
              </div>
            </div>
            ...
            <div class="detail-mid-require">
              <div class="detail-left">Stamina required</div>
              <div class="detail-right">
                {{ confirmDetailsForm.expBodyPower || 0 }}
              </div>
            </div>
            ...
            <div class="detail-mid-bottom">
              ...
              <div class="detail-right">
                {{ confirmDetailsForm.expProfit || 0 }} DMP
              </div>
            </div>
            ...
            <div
              class="tips"
              v-if="
                staminaForm.userPower.power < confirmDetailsForm.expBodyPower
              "
            >
              * Not enough! You only have
              {{ staminaForm.userPower.power }} stamina left.
            </div>
          </div>
          ...
          <div class="content-btns">
            ...
            <div v-else class="confirm select-hover no-data">Confirm</div>
          </div>
        </div>
      </div>
...
.modal {
  ...
  .modal-contain {
    ...
    .modal-content {
      ...
      .no-data {
        background: rgba(255, 199, 99, 0.55) !important;
      }
    }
  }
