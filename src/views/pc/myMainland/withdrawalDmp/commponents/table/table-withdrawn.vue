<template>
  <div class="table-not-withdrawn-main">
    <div class="table-item-title">
      ...
      <div class="btns">
        <div class="text text-opacity">Arrival time</div>
      </div>
    </div>
    <div
    ...
    >
      <div v-if="list.length > 0" class="table-item-wrap-main">
        ...
        >
          ...
          <div class="amount">
            <!-- <div class="maount-img">
            <img src="@/assets/imgs/myMainland/dragon-top/DMS.png" alt="" />
          </div>
          ...
          <div class="status">
            ...
            <div class="text text-opacity" v-if="item.status == 2">
          ...
          <div class="fee">
            <div v-if="item.rate == 0" class="text text-opacity">No fee</div>
            <div v-else class="text">
              {{ item.rate }}%
              <div class="fee-tips">
...
export default {
  ...
  setup() {
    ...
    const { back, withdrawlDmpState, selectData, selectedAllData } =
      withdrawlDmpHandle();
    onMounted(() => {
      // common.goTopScroll();
    });
