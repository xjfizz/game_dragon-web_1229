        ...
        <div class="modal-content">
          <div class="title">
            <div class="title-left" @click="back">
              <img src="@/assets/imgs/myMainland/breed/left.png" alt="" />
              Back
            </div>
            <div class="title-mid">Select A Dragon</div>
            ...
            <div class="content-title">
              <div class="content-title-left">
                <div class="dragon-num">
                  <div class="total-num">{{ pageInfo.total || 0 }} Dragons</div>
                </div>
              </div>
            </div>
            <div v-if="pageInfo.total > 0" class="content-list">
              <div
                class="dragon-item select-dragon-hover"
                :class="
                  item.isSelected  || item.isLocked
                    ? 'no-data'
                    : ''
                "
                v-for="(item, index) in devouringList"
                :key="index"
