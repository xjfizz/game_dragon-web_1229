  ...
  >
      ...
      <div class="btns-wrap-main">
        <div class="bottom">
          <div>
            <div
              v-if="
                dragonDetail.productDetail &&
                dragonDetail.productDetail.heroProduct.saleType == 2
              "
              class="market-time"
            >
              <div class="time-top-days">
                in
                {{ dragonDetail.productDetail.heroProduct.auctionHour / 24 }}
                days
              </div>
              <div class="time-top">
                <div
                  class="time-left"
                  v-if="dragonDetail.productDetail.timeProgress == '100%'"
                ></div>
                ...
                <div class="time-mid">
                  <div
                    ...
                    :style="{
                      width: dragonDetail.productDetail.timeProgress,
                    }"
                  ></div>
                ...
                <div
                  class="time-right"
                  v-if="dragonDetail.productDetail.timeProgress != '0%'"
                ></div>
              ...
              <div class="time-bottom">
                <div class="left-text-round">
                  {{
                    dragonDetail.productDetail.heroProduct.auctionHighestPrice
                  }}
                </div>
                <div class="right-text-round">
                  {{
                    dragonDetail.productDetail.heroProduct.auctionLowestPrice
                  }}
                </div>
              </div>
            </div>
            <div class="btn-market-des">
              <div class="market-des-top">
                ...
                <div v-if="dragonDetail.productDetail" class="text">
                  {{ dragonDetail.productDetail.heroProduct.price }}
                </div>
              </div>
    ...
    <div class="right">
      <div class="right-wrap">
        ...
        <div class="right-takeIn-history">
          <div class="title">
            Develop history
            <div class="title-des-tip" v-if="isWaitOrder == 1">
              (The dragon has a pending order)
            </div>
            <div class="title-des-tip" v-if="isWaitOrder == 2">
              (The dragon has a pending order)
            </div>
            <div class="title-des-tip" v-if="isWaitOrder == 3">
              (The dragon has 2 pending order)
            </div>
          </div>
          <div class="about-content">
            <div class="about-content-wrap">
              ...
              >
                <div class="history-left">
                  <div class="history-item-bottom">
                    {{ common.formatAddress2(item.account) || "--" }}
                  </div>
                </div>
                <div class="history-mid">
                  <div class="history-item-bottom">
                ...
                <div class="history-mid2">
                  <div v-if="item.type == 1" class="history-item-bottom">
                    Skull Absorption
                  </div>
                  <div v-else-if="item.type == 7" class="history-item-bottom">
                    Talent Promotion
                  </div>
                  <div v-else class="history-item-bottom">
                    <div class="skill-name" v-if="item.attributeName">
                      ({{ item.attributeName }})
                    </div>
                    Skill
                  </div>
                ...
                <div class="history-right">
                  <div v-if="item.status == 7" class="history-item-bottom">
                    {{ item.oldAttributeVal }} → {{ item.newAttributeVal }}
                  </div>
                  <div v-else-if="item.type == 1" class="history-item-bottom">
            ...
            <div v-else class="about-content-wrap">
