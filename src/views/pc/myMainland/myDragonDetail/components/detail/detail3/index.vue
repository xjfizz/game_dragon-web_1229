        ...
        >
          <div class="btn-wrap">
            ...
            <div
              v-if="false"
              class="item-btn select-bc-hover"
              @click="devouringTalent(dragonDetail, myAddress)"
              @mouseenter="tipList[4].show = true"
              @mouseleave="tipList[4].show = false"
            >
              <img
                src="@/assets/imgs/myMainland/dragonDetail/dragon-my-btn/devouring.png"
                alt=""
              ...
              <PopupMsg
                class="right-img-msg"
                :showPopop="tipList[4].show"
                :msgList="tipList[4].text"
                :showIndex="false"
              />
            </div>
...
export default {
  ...
  setup() {
    ...
    const { devouringState, devouring, devouringTalent } = devouringHandle();
    onMounted(() => {
      common.goTopScroll();
    });
