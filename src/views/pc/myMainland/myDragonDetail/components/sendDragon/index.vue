    ...
    <div class="modal">
      ...
      >
        <div class="modal-content">
          <div class="title">Gift your Dragon</div>
          <div class="title-des">
            you are about to gift Dragon #{{ dragonDetail.no }} to other
            person,enter receiver's wallet address to continue:
          </div>
          ...
          <div class="send-tips">Please check the address is correct to avoid unnecessary losses</div>
          <div class="send-btns">
            <div class="cancel-btn" @click="closeBox">Cancel</div>
            <div
              v-if="sendForm.walletAddress"
              class="submit-btn"
              @click="confirm"
            >
              Confirm
            </div>
            <div v-if="!sendForm.walletAddress" class="submit-btn-no-data">
              Confirm
            </div>
          </div>
        </div>
