<template>
  <div class="verificat-form">
    <div class="verificat-form-content">
      ...
      <div class="des">
        You have send successfully, please enter
      ...
      <div
        v-if="formEmail.code && formEmail.password"
        class="submit-btn"
        @click="validForgetPassword"
      >
        reset
      </div>
      <div v-else class="submit-btn no-data">reset</div>
    </div>
  </div>
</template>
...
export default {
  ...
  setup(props, context) {
    ...
    const validForgetPassword = () => {
      ...
      context.emit("validForgetPassword");
    };
