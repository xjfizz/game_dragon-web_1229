              ...
              <div class="item-select-left" v-if="selectItem == 2">
                <div class="item-select-left-wrap">
                  ...
                  >
                    ...
                    <div
                      class="selected-img"
                      v-if="item.url == dragonSelect.eye.url"
                    >
                      <img
                        src="@/assets/imgs/dragonPlay/characteristic/item-selected.png"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div class="item-select-left" v-if="selectItem == 3">
                <div class="item-select-left-wrap">
                  ...
                  >
                    ...
                    <div
                      class="selected-img"
                      v-if="item.url == dragonSelect.ear.url"
                    >
                      <img
                        src="@/assets/imgs/dragonPlay/characteristic/item-selected.png"
                      />
              ...
              <div class="item-select-left" v-if="selectItem == 4">
                <div class="item-select-left-wrap">
                  ...
                  >
                    ...
                    <div
                      class="selected-img"
                      v-if="item.url == dragonSelect.horn.url"
                    >
                      <img
                        src="@/assets/imgs/dragonPlay/characteristic/item-selected.png"
                      />
            ...
            <div class="item-select-left" v-if="selectItem == 1">
              <div class="item-select-left-wrap">
                ...
                >
                  ...
                  <div
                    class="selected-img"
                    v-if="item.url == dragonSelect.body.url"
                  >
                    <img
                      src="@/assets/imgs/dragonPlay/characteristic/item-selected.png"
                    />
              ...
              <div class="item-select-right" v-if="selectItem == 5">
                <div class="item-select-right-wrap">
                  ...
                  >
                    ...
                    <div
                      class="selected-img"
                      v-if="item.url == dragonSelect.wing.url"
                    >
                      <img
                        src="@/assets/imgs/dragonPlay/characteristic/item-selected.png"
                      />
              ...
              <div class="item-select-right" v-if="selectItem == 6">
                <div class="item-select-right-wrap">
                  ...
                  >
                    ...
                    <div
                      class="selected-img"
                      v-if="item.url == dragonSelect.totems.url"
                    >
                      <img
                        src="@/assets/imgs/dragonPlay/characteristic/item-selected.png"
                      />
              ...
              <div class="item-select-right" v-if="selectItem == 7">
                <div class="item-select-right-wrap">
                  ...
                  >
                    ...
                    <div
                      class="selected-img"
                      v-if="item.url == dragonSelect.tail.url"
                    >
                      <img
                        src="@/assets/imgs/dragonPlay/characteristic/item-selected.png"
                      />
...
import dragonData from "@/assets/data/dragon.js";
...
export default {
  ...
  setup() {
    ...
    const refreshDragon = () => {
      ...
      state.dragonSelect = {
        body: {
          url: getDragon("body", dragon.body).url,
        },
        eye: {
          url: getDragon("eye", dragon.eye).url,
        },
        ear: {
          url: getDragon("ear", dragon.ear).url,
        },
        horn: {
          url: getDragon("horn", dragon.horn).url,
        },
        wing: {
          url: getDragon("wing", dragon.wing).url,
        },
        totems: {
          url: getDragon("totems", dragon.totems).url,
        },
        tail: {
          url: getDragon("tail", dragon.tail).url,
        },
      };

      console.log("getDragon", state);

      dragonCreate.value.initDragon(dragon);
    };

    // 获取龙部件对象
    const getDragon = (key, value) => {
      let str = null;
      state.dragon[key].map((item) => {
        let item2 = value.substring(
          value.indexOf("/") + 1,
          value.lastIndexOf(".")
        );
        if (item.createUrl.indexOf(item2) > -1) {
          str = item;
        }
      });
      return str;
