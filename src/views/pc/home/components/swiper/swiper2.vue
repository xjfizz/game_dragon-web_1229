...
<template>
  <div class="head">
    ...
    <div class="right-btn" @click="moveRight()"  @mouseenter="mouseenterRight"
    ...
    const state = reactive({
      swiperList: [
       
        {
          num: 1,
          text: "Map + Roguelike",
          icon: require("../../../../../assets/imgs/swiper/fantastic-swiper-img2.png"),
        },
        {
          num: 2,
          text: "AR Show",
          icon: require("../../../../../assets/imgs/swiper/fantastic-swiper-img3.png"),
        },
         {
          num: 2,
          text: "Turn-based Combat",
          icon: require("../../../../../assets/imgs/swiper/fantastic-swiper-img5.png"),
        },
        {
          num: 2,
          text: "Breeding System",
          icon: require("../../../../../assets/imgs/swiper/fantastic-swiper-img4.png"),
        },
       
         {
          num: 0,
          text: "3D Characteristic",
          icon: require("../../../../../assets/imgs/swiper/fantastic-swiper-img1.png"),
        },
      ],
