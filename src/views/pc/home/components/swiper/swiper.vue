      ...
      swiperList: [
        {
          num: 1,
          text: "Map + Roguelike",
          icon: require("../../../../../assets/imgs/swiper/new/swiper-img2.png"),
        },
        {
          num: 2,
          text: "AR Show",
          icon: require("../../../../../assets/imgs/swiper/new/swiper-img3.png"),
        },
        {
          num: 3,
          text: "Battle",
          icon: require("../../../../../assets/imgs/swiper/new/swiper-img5.png"),
        },
        {
          num: 4,
          text: "Breeding System",
          icon: require("../../../../../assets/imgs/swiper/new/swiper-img4.png"),
        },

        {
          num: 5,
          text: "3D Characteristic",
          icon: require("../../../../../assets/imgs/swiper/new/swiper-img1.png"),
        },
      ],
  ...
  .mid-wrap {
    ...
    .mid-wrap-swiper {
      ...
      .mid-wrap-item {
        ...
        background-image: url("../../../../../assets/imgs/swiper/new/fantastic-swiper-img-bc.png");
        .mid-wrap-item-title {
          margin-top: 26px;
          margin-left: 23px;
          font-size: 28px;
