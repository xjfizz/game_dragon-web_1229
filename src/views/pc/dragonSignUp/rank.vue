<template>
  <div class="receive-main">
    ...
    <div class="bottom">
      <div class="top-wrap">
        <div class="title">List of Successful Applicants</div>
        <div class="content-des">
          <div class="content-des-item">
            Congratulations to the following users who have been selected for
            the whitelist. Please keep an eye on this page as we will open the
            payment portal on Nov. 5 at 12pm UTC. For those who have
            successfully paid your 1000 DMS will be distributed when DEX is
            online.
          </div>

          <div class="content-des-item">
            If you have any questions please contact:
            services@dragonmainland.io. Thanks again for your support of Dragon
            Mainland!
          </div>

          <div class="content-des-item">
            *After the payment portal opens please complete your payment within
            24 hours, after which your whitelist status will be cancelled!
          </div>

          <!-- <div class="content-des-item">
            Thank you for your support of Dragon Mainland!
          </div> -->
        </div>
      </div>
      <div
      ...
      >
        <!-- <div class="pay-address" v-if="form && form.status == 1 && ($process_env == 'production' ? isPay  : true)"> -->
          <div class="pay-address">
          <div class="left">{{ receiveWallet.contractAddress || "" }}</div>
          <div
            v-if="
              form &&
              (form.bnbPayStatus == 0 || form.bnbPayStatus == 1) &&
              form.status == 1
            "
            class="right"
            @click="pay"
          ...
          <div class="left">
            <div class="item-input">
              ...
              <div class="search-icon" @click="confirmSearch">
                <img src="@/assets/imgs/dragonSignUp/search.png" alt="" />
              </div>
            </div>
          </div>
          <!-- <div v-if="true" class="right" @click="confirmSearch">
