        ...
        <div class="content-des">
          <div class="content-des-time">
            ...
            <div class="time-title">
              Start Time：9th October (00:00:00 UTC+4)
            </div>
          </div>
          ...
          <div class="content-des-steps">
            <div class="steps1">
              ...
              <div class="step-content">
                ...
                <div class="right">
                  "Following our Twitter:DragonMainland <br />
                  Entering our telegram:
                  <div class="text" @click="goHref1">https://t.me/dragon_mainland</div>
                  telegramChanel:
                  <div class="text" @click="goHref2">https://t.me/dragonmainland_ann"</div>
                </div>
              </div>
            </div>
            <div class="steps2">
      ...
      <div class="bottom-wrap">
        ...
        <div class="content">
          <div class="submit-item">
            ...
            <div class="item">
              <div class="item-title">* BSC Address(BEP-20)</div>
              <div class="item-input">
                <el-input
                  disabled
          ...
          <div class="submit-img">
            <div class="submit-img-title">
              Upload 3 screenshots of following the official channel as well as
              retweeting it.
            </div>
            <div class="submit-img-wrap">
              <div class="item-img">
                <input
                  type="file"
                  name="file"
                  class="up-add"
                  @change="getFile1($event, 'file')"
                />
                <div class="img-nodata" v-if="!imgUrl1">
                  <img
                    src="@/assets/imgs/activity/activityReceive/upload-img.png"
                    alt=""
                  />
                  <div class="img-des">
                    upload your screenshot about telegram
                  </div>
                </div>
                <div class="img-data" v-else>
                  <img :src="imgUrl1" alt="" />
                </div>
              </div>
              <div class="item-img">
                <input
                  ...
                  name="file"
                  class="up-add"
                  @change="getFile2($event, 'file')"
                />
                <div class="img-nodata" v-if="!imgUrl2">
                  <img
                    src="@/assets/imgs/activity/activityReceive/upload-img.png"
                    alt=""
                  />
                  <div class="img-des">
                    upload your screenshot about telegramChanel
                  </div>
                </div>
                <div class="img-data" v-else>
                  <img :src="imgUrl2" alt="" />
              ...
              <div class="item-img">
                <input
                  ...
                  name="file"
                  class="up-add"
                  @change="getFile3($event, 'file')"
                />
                <div class="img-nodata" v-if="!imgUrl3">
                  <img
                    src="@/assets/imgs/activity/activityReceive/upload-img.png"
                    alt=""
                  />
                  <div class="img-des">
                    Upload your screenshot about Twitter
                  </div>
                </div>
                <div class="img-data" v-else>
                  <img :src="imgUrl3" alt="" />
