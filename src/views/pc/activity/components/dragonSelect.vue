  ...
  >
    ...
    <div class="egg-bottom-wrap">
      <div class="text">
        ...
        <div v-else-if="selectDragonIndex == 4">
          <!-- wind -->
          0.2
        </div>
         <div v-else-if="selectDragonIndex == 5">
          <!-- wind -->
          0.3
        </div>
        <div v-else>???</div>
    ...
    >
      <img
        ...
        :class="
          'dragon-img-item' +
          selectDragonIndex2 +
          (dragonType != dragonList[1].type || !dragonNumber
            ? ' dragonEnbleBuy'
            : '')
        "
      />
    ...
    >
      <img
        ...
        :class="
          'dragon-img-item' +
          selectDragonIndex3 +
          (dragonType != dragonList[2].type || !dragonNumber
            ? ' dragonEnbleBuy'
            : '')
        "
      />
    ...
    >
      <img
        ...
        :class="
          'dragon-img-item' +
          selectDragonIndex4 +
          (dragonType != dragonList[3].type || !dragonNumber
            ? ' dragonEnbleBuy'
            : '')
        "
      />
    ...
    >
      <img
        ...
        :class="
          'dragon-img-item' +
          selectDragonIndex5 +
          (dragonType != dragonList[4].type || !dragonNumber
            ? ' dragonEnbleBuy'
            : '')
        "
      />
