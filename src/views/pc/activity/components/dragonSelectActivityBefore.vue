<template>
  <div class="dragon-select-mid-wrap">
    <div class="egg-wrap">
    ...
    <div class="buy-bottom">
      <!-- <div class="bottom-text">
        Fire Dragon: Violent battle
        <div class="bottom-text-des">Only {{dragonNumber || 0}} Eggs</div>
      </div> -->

      <div class="bottom-btn dragonEnbleBuy">
...
export default {
  setup() {
    ...
    let { selectRightDragon, selectLeftDragon, init, state, buyEgg } =
      selectDragon();
