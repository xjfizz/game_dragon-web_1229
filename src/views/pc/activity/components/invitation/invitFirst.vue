          ...
          <div class="content-bottom" >
            <div class="wrap">
              ...
              <div v-if="page.pageBtns > 5" class="item-wrap">
                <div
                  class="item"
                  v-for="(item, index) in (page.pageBtnsWrap*5 > page.pageBtns ? page.pageBtns%5 : 5)"
                  :key="index"
                  :class="
   ...
   <div class="right">
      <div class="right-wrap">
        ...
        <div class="top-link" v-else>
          ...
          <div class="bottom" v-if="invitUserRankList.length > 0">
        ...
        <div class="bottom">
          ...
          <div class="bottom-content">
            ...
            <div class="item">
              2. Available time: from 10/09/2021(UTC+4) to the end of all rounds' rush
            </div>
