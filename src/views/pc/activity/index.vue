<template>
  <div class="main">
    ...
    ></invitation>
    <imgCode v-if="buyImgCodeShow"></imgCode> 
    <!-- 弹框-start -->
    <div class="top">
      ...
      <div class="top-content">
        ...
        <div class="mid-dragin-select" v-if="timeFinish">
          <dragonSelect></dragonSelect>
        </div>
        <div class="mid-count-down" v-else>
          <countDown></countDown>
          <countDownDragonDraw></countDownDragonDraw>
        </div>
        <div class="right">
          <div class="help">
            <img
...
import dragonSelect from "./components/dragonSelect.vue";
import countDown from "./components/countDown.vue";
import countDownDragonDraw from "./components/countDownDragonDraw.vue";
...
import imgCode from "@/components/modalBox/imgCode/index.vue";
