...
// 初始化数据
const skullState = reactive({
    swapLink: 'https://pancakeswap.finance/swap',
    dmpLink: '0x599107669322B0E72be939331f35A693ba71EBE2',
    skullLink:' https://medium.com/@DragonMainland_/blind-box-tutorial-ecba7ad7b830'
...
export default function skullStateHandle() {
    ...
    const goDmpLink  = () => { //https://bscscan.com/address/0x9a26e6D24Df036B0b015016D1b55011c19E76C87
        window.open(`https://bscscan.com/address/${skullState.dmpLink}`, "_blank");
    }
    ...
    const goHref = ()=> {
        window.open(skullState.skullLink, "_blank");
    }
    ...
    const goBlindBox = ()=> {
        window.open('/#/myMainland/blindBox', "_blank");
    }
